...
This text is available under the MIT license from [Github](https://github.com/hoehleatsu/When2Stop) and as an [RPubs](http://rpubs.com/hoehle/179204).
...
* Let $K(t)$ be the total number of bugs found up to time $t$. 
